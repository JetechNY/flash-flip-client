...
class MainContainer extends React.Component {
  ...
  handleDeleteCard = (cardId) => {
    ...
    const matchedCardIndex = newFilteredCards.findIndex(
      (card) => card.id === cardId
    );
  ...
  handleDeleteCategory = (categoryId) => {
    fetch(`http://localhost:3000/categories/${categoryId}`, {
      ...
      .then((data) => {
        ...
        const matchedCatIndex = newFilteredCategories.findIndex(
          (cat) => cat.id === categoryId
        );
        newFilteredCategories.splice(matchedCatIndex, 1);
        this.setState({
          categories: newFilteredCategories,
  ...
  filteredCategory = (searchTerm) =>
    this.state.categories.filter((cat) =>
    ...
    return (
      <Container>
        <div className="main-container">
          {this.state.gameState ? (
            ...
            <>
              <CategoryContainer
                ...
                handleFavCardList={this.handleFavCardList}
                handleFilterCards={this.handleFilterCards}
                ...
                handleShowCategoryForm={this.handleShowCategoryForm}
          ...
          {this.state.filteredCategory || this.state.favList ? null : (
            <p className="select-category-holder">
